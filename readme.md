...
1. Install all the libraries mentioned in the [requirements.txt](https://github.com/ajay-kaushik/Data-Science-Project/tree/main/Movie-Recommendation-with-Sentiment-Analysis/requirements.txt) file.
